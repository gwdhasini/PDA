...
## todo: mettre head ici + guarantor enlever 2
```
...
todo --> grand range plus de chance outliers
...
```
-> vertical to compare the median
-> variation
## Good vs Bad credits
```{r, echo=FALSE}
...
-> scale the data for the continuous variable it's better for nn: mettre dans le modeling
