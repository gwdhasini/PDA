...
With this in mind, we could state that the choice of model depends on the task at hand. Even though the Radial SVM model is the second best in overall accuracy it does not predict both classes in a balanced way and should thus be avoided. To choose the model, one should focus on the scope of the project. There is not one best model.